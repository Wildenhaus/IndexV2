...
namespace LibSaber.HaloCEA.Structures
{
  ...
  public class SubmeshInfo
  {
    ...
    [Sentinel( SentinelIds.Sentinel_0105 )] public Data_0105? FaceInfo;
    [Sentinel( SentinelIds.Sentinel_010B )] public List<Data_010B> MaterialList;
    [Sentinel( SentinelIds.Sentinel_010D )] public Data_010D? VertexInfo;
    ...
    public static SubmeshInfo Deserialize( NativeReader reader, ISerializationContext context )
    {
      var data = new SubmeshInfo();
      ...
      while ( sentinelReader.Next() )
      {
        switch ( sentinelReader.SentinelId )
        {
          case SentinelIds.Sentinel_0105:
            data.FaceInfo = Data_0105.Deserialize( reader, context );
            break;
          case SentinelIds.Sentinel_010B:
            data.MaterialList = DataList<Data_010B>.Deserialize( reader, context, Data_010B.Deserialize );
            break;
          case SentinelIds.Sentinel_010D:
            data.VertexInfo = Data_010D.Deserialize( reader, context );
            break;
